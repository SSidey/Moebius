...
pub const MOEB_GITHUB_APP_ID: u64 = 0; // TODO: set GitHub App ID
pub const MOEB_GITHUB_APP_INSTALLATION_ID: u64 = 0; // TODO: set installation ID
...
pub const MOEB_GITHUB_REPO_SLUG: &str = "owner/moeb"; // TODO: set owner/repo
```
