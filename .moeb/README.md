...
| Review Sub-Agent Adapter Wiring and QA Review Clarity | Fixes MCP-mode query_agent to build the configured adapter eagerly at server startup and aligns start_run.rs review-flag logic with the CLI path; rephrases run.skill.md review skip conditions to eliminate double-negative ambiguity | [specifications/moeb/moeb.review-adapter-wiring-and-qa-clarity.md](specifications/moeb/moeb.review-adapter-wiring-and-qa-clarity.md) | active |
