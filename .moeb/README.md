...
| Sub-Agent Spawning | Introduces a spawn_agent tool that delegates bounded file-analysis tasks to isolated sub-agent loops returning unified diffs; coordinator applies diffs via patch_file, maintaining coordinator-only write invariant and context isolation per sub-task | [specifications/moeb/moeb.sub-agent-spawning.md](specifications/moeb/moeb.sub-agent-spawning.md) | active |
