...
| Kernel Thinness and MCP/CLI Parity Rubrics | Adds two trait-keyed catalogue rubric entries: thin-kernel (kernel-change trait, spec+run) requiring new Rust to be primitive wrappers or thin dispatchers only, and mcp-cli-behavioural-parity (mcp-surface trait, run) requiring identical observable outcomes across CLI and MCP surfaces | [specifications/moeb/moeb.kernel-thin-and-mcp-parity-rubrics.md](specifications/moeb/moeb.kernel-thin-and-mcp-parity-rubrics.md) | active |
