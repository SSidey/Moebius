...
| `new-skill-mandatory-phases` | New Skill Mandatory Phases | Any `*.skill.md` file written during this run contains all mandatory phase heading strings: "Verify", "End-of-Skill Review", "Metrics Recording", "Commit", "Tag", "Complete" | All six strings present in the written skill file | moeb | skill-authoring | run | superseded — duplicate of skill-mandatory-phases in src/moeb/internal/rubrics/global.rubrics.md |
